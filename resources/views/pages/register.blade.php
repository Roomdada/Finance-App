    ...
    <div class="row no-gutters h-100">
        ...
        <div class="container my-4">
          <div class="row">
            <div class="col-11 col-lg-9 col-xl-8 mx-auto">
              <h3 class="font-weight-400 mb-4">Inscrivez-vous</h3>
               @livewire('register-component')
              <p class="text-3 text-center text-muted">Vous avez déjà un compte ? <a class="btn-link" href="{{ route('login') }}">Identifier-vous</a></p>
            </div>
          </div>
        </div>
        <!-- SignUp Form End --> 
      ...
      <div class="col-md-6"> 
        ...
        <div class="hero-wrap d-flex align-items-center h-100">
          ...
          <div class="hero-bg hero-bg-scroll" style="background-image:url('assets/images/bg/image-3.jpg');"></div>
          <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
            <div class="row  no-gutters">
              <div class="col-10 col-lg-9 mx-auto">
                <div class="logo mt-5 mb-5 mb-md-0"> <a class="d-flex" href="index.html" title="Payyed - HTML Template"><img src="{{asset('assets/images/logo-light.png')}}" alt="Payyed"></a> </div>
              </div>
            </div>
            <div class="row my-auto">
              <div class="col-10 col-lg-9 mx-auto">
                <h1 class="text-11 text-white mb-4">Faites-vous vérifier !</h1>
                <p class="text-4 text-white line-height-4 mb-5">Chaque jour, Payyed rend des milliers de clients heureux.</p>
              </div>
            </div>
          </div>
        </div>
