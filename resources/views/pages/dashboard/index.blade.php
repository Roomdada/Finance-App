                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="bg-white shadow-sm rounded p-4 mb-4">
                            <h3 class="text-5 font-weight-400 d-flex align-items-center mb-4">Mon compte<span class="border text-success rounded-pill font-weight-500 text-2 px-3 py-1 ml-2"></span></h3>
                            <hr class="mb-4 mx-n4">
                            <div class="row profile-completeness">
                                <div class="col-sm-6 col-md-3 mb-4 mb-md-0">
                                    <div class="border rounded text-center px-3 py-4"> <span class="d-block text-10 text-light mt-2 mb-3"><i class="fas fa-mobile-alt"></i></span> <span class="text-5 d-block text-success mt-4 mb-3"><i class="fas fa-check-circle"></i></span>
                                        <p class="mb-0">Numero de telephone</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3 mb-4 mb-md-0">
                                ...
                                <div class="col-sm-6 col-md-3 mb-4 mb-sm-0">
                                    <div class="border rounded text-center px-3 py-4"> <span class="d-block text-10 text-light mt-2 mb-3"><i class="fas fa-user"></i></span> <span class="text-5 d-block text-danger mt-4 mb-3"><i class="far fa-times-circle "></i></span>
                                        <p class="mb-0"><a class="btn-link stretched-link" href="#" data-toggle="tooltip" title="Code de parrainage: {{auth()->user()->code_parrain}}">Trouver un filleuls</a></p>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <div class="border rounded text-center px-3 py-4"> <span class="d-block text-10 text-light mt-2 mb-3"><i class="fas fa-minus-circle"></i></span> <span class="text-5 d-block text-danger mt-4 mb-3">
                                        <i class="far fa-times-circle"></i></span>
                                        <p class="mb-0"><a class="btn-link stretched-link" href="#">Investir</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>

                        @if(!auth()->user()->validation_1)
                            <div class="bg-white shadow-sm rounded py-4 mb-4">
                                <h3 class="text-5 font-weight-400 d-flex align-items-center px-4 mb-4">Activiter recente</h3>

                                <!-- Title =============================== -->
                                <div class="transaction-title py-2 px-4">
                                    <div class="row font-weight-00">
                                        <div class="col-2 col-sm-1 text-center"><span class="">Date</span></div>
                                        <div class="col col-sm-7">Type</div>
                                ...
                                <!-- Transaction List =============================== -->
                                <div class="transaction-list" style="display: block;">
                                    <div class="transaction-item px-4 py-3" data-toggle="modal" data-target="#transaction-detail">
                                        <div class="row align-items-center flex-row">
                                            ...
                                            <div class="col col-sm-7"> <span class="d-block text-4">Retrait</span></div>
                                    ...
                                    <div class="transaction-item px-4 py-3" data-toggle="modal" data-target="#transaction-detail">
                                        <div class="row align-items-center flex-row">
                                            ...
                                            <div class="col col-sm-7"> <span class="d-block text-4">Dépôt</span></div>
                                    ...
                                    <!-- View all Link
                                                =============================== -->
                                    <div class="text-center mt-4"><a href="transactions.html" class="btn-link text-3">Voir tous les transactions<i
                                ...
                                <div class="transaction-list transaction-list__empty" style="display: none;">
                                    <p>Faite un investisment pour valider votre compter</p>
                                </div>
                                <!-- Empty Transaction List End -->
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-sm-5 d-flex justify-content-center bg-primary rounded-left py-4">
                                                        <div class="my-auto text-center">
                                                            <div class="text-17 text-white my-3"><i class="fas fa-arrow-down"></i></div>
                                                            <!-- <div class="text-17 text-white my-3"><i class="fas fa-arrow-up"></i></div> -->
                                                            <h3 class="text-4 text-white font-weight-400 my-3">Dépôt</h3>
                                                    ...
                                                    <div class="col-sm-7">
                                                        ...
                                                        <div class="px-3">
                                                            <ul class="list-unstyled">
                                                                <li class="mb-2">Monatnt payer<span class="float-right text-3">$562.00</span></li>
                                                                <li class="mb-2">RSI <span class="float-right text-3">-$4.80</span></li>
                                                            </ul>
                                                            <hr class="mb-2">
                                                            <ul class="list-unstyled">
                                                                <li class="font-weight-500">Action</li>
                                                                <li class="text-muted">
                            ...
                            <div class="alert alert-info text-center ">
                                <p class="mt-2 text-center">Veuillez effectuer votre premiere transaction pour debuter votre aventure</p>
                            </div>
                        @endif
                    </div>
                </div>
