                            ...
                            <div class="col mb-2">
                                <form id="filterTransactions" method="post">
                                    <div class="form-row">
                                        ...
                                        <!-- All Filters Link ========================= -->
                                        <div class="col-auto d-flex align-items-center mr-auto form-group" data-toggle="collapse"> <a class="btn-link" data-toggle="collapse" href="#allFilters" aria-expanded="false" aria-controls="allFilters">Tous les filtres<i class="fas fa-sliders-h text-3 ml-1"></i></a> </div>
                                        <!-- Statements Link ========================= -->
                                        ...
                                        <div class="col-12 collapse mb-3" id="allFilters">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <label class="custom-control-label" for="paymentsSend">Investisement</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="paymentsReceived" name="allFilters" class="custom-control-input">
                                                <label class="custom-control-label" for="paymentsReceived">Retrait</label>
                                            </div>
                                        </div>
                            ...
                            <div class="transaction-list">
                                ...
                                <div class="transaction-item px-4 py-3" data-toggle="modal" data-target="#transaction-detail">
                                    <div class="row align-items-center flex-row">
                                        ...
                                        <div class="col col-sm-7"> <span class="d-block text-4">Investisement</span></div>
                                              ...
                                              aria-hidden="true">&times;</span> </button>
                                                ...
                                                supprimer la transaction
                                                        ...
                                                        <ul class="list-unstyled">
                                                            ...
                                                            <li class="text-muted">Completed<span class="text-success text-3 ml-1"><i
