                    ...
                    <div class="col-md-4 mb-4">
                        <div class="bg-white shadow-md rounded h-100 p-3">
                            <div class="featured-box text-center">
                                ...
                                <h3>Payyed Inc.</h3>
                                <p>4th Floor, Plot No.22, Above Public Park<br> 145 Murphy Canyon Rd.<br> Suite 100-18<br> San Diego CA 2028 </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
            ...
            <section class="hero-wrap section shadow-md">
                ...
                <div class="hero-content py-5">
                    <div class="container text-center">
                        <h2 class="text-9 text-white">Devenez riche avec nous</h2>
                        <p class="lead text-white mb-4">Qu'attendez-vous pour prend votre envol et atteindre une indépendance financière complète
                        </p>
                        <a href="{{ route('register') }}" class="btn btn-light">Lancez-vous maintenant</a>
                    </div>
                </div>
            </section>
